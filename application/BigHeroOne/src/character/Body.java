...
public class Body {
	...
	float deltaULowerBody = (float)(ueLowerBody-uaLowerBody)/mLowerBody;								//wie groﬂ ein einzelner Teilschritt sein muss in u-Richtung
	float deltaVLowerBody = (float)(veLowerBody-vaLowerBody)/nLowerBody;								//wie groﬂ ein einzelner Teilschritt sein muss in v-Richtung
	...
	float deltaUUpperBody = (float)(ueUpperBody-uaUpperBody)/mUpperBody;								//wie groﬂ ein einzelner Teilschritt sein muss in u-Richtung
	float deltaVUpperBody = (float)(veUpperBody-vaUpperBody)/nUpperBody;								//wie groﬂ ein einzelner Teilschritt sein muss in v-Richtung
	...
	float deltaUMiddleBody = (float)(ueMiddleBody-uaMiddleBody)/mMiddleBody;							//wie groﬂ ein einzelner Teilschritt sein muss in u-Richtung
	float deltaVMiddleBody = (float)(veMiddleBody-vaMiddleBody)/nMiddleBody;							//wie groﬂ ein einzelner Teilschritt sein muss in v-Richtung
