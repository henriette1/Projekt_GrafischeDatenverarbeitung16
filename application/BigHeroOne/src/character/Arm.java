...
public class Arm{
	...
	// private Variablen
		...
		float deltaUUpperArm = (float)(ueUpperArm-uaUpperArm)/mArm;							//wie groﬂ ein einzelner Teilschritt sein muss in u-Richtung
		float deltaVUpperArm = (float)(veUpperArm-vaUpperArm)/nArm;							//wie groﬂ ein einzelner Teilschritt sein muss in v-Richtung
	...
	float deltaUForeArm = (float)(ueForeArm-uaForeArm)/mArm;							//wie groﬂ ein einzelner Teilschritt sein muss in u-Richtung
	float deltaVForeArm = (float)(veForeArm-vaForeArm)/nArm;							//wie groﬂ ein einzelner Teilschritt sein muss in v-Richtung
	...
	float deltaUHand = (float)(ueHand-uaHand)/mHand;								//wie groﬂ ein einzelner Teilschritt sein muss in u-Richtung
	float deltaVHand = (float)(veHand-vaHand)/nHand;								//wie groﬂ ein einzelner Teilschritt sein muss in v-Richtung
