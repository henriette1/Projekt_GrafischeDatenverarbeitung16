...
import app.MyFloor;
import app.MyKoordinatensystem;
...
public class MyScene
{
	...
	private MyFloor floor = new MyFloor();
	private MyKoordinatensystem koord = new MyKoordinatensystem();
	private Terrain terrain = new Terrain(0, 0, "heightMap");
